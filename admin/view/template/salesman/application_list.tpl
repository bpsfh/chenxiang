      ...
      <div class="panel-body">
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <select name="filter_status" id="input-status" class="form-control">
                  <option value="*"></option>
                  <?php if ($filter_status &&　($filter_status == 0)) { ?>
            ...
            <div class="col-sm-3">
              <div class="form-group">
                <label class="control-label" for="input-apply-date"><?php echo $entry_apply_date; ?></label>
                <div class="input-group date">
                  <input type="text" name="filter_apply_date" value="<?php echo $filter_apply_date; ?>" placeholder="<?php echo $entry_apply_date; ?>" data-date-format="YYYY-MM-DD" id="input-apply-date" class="form-control" />
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'apply_date') { ?>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $application['apply_date']; ?></td>
