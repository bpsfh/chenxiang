...
class ControllerSalesmanContact extends Controller {
	...
	public function index() {
		...
		foreach ($contacts as $key=>$contact) {
			...
			$data['contacts'][] = array(
					...
					'edit'                 => $this->url->link('salesman/contact/getForm', 'token=' . $this->session->data['token'] . '&contact_id=' . $contact['contact_id'] . $url, 'SSL')
			);
		}
		...
		$this->response->setOutput($this->load->view('salesman/contact_list.tpl', $data));
	}
	...
	public function getForm() {
		...
		$contact_info = $this->model_salesman_contact->getContact($contact_id);
		...
		$data['cancel'] = $this->url->link('salesman/contact', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['action'] = $this->url->link('salesman/contact/edit', 'token=' . $this->session->data['token'] . '&contact_id=' . $this->request->get['contact_id'] . $url, 'SSL');
		...
		$this->response->setOutput($this->load->view('salesman/contact_form.tpl', $data));
	}
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->model_salesman_contact->editContact($this->request->get['contact_id'], $this->request->post);
