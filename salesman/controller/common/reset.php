...
class ControllerCommonReset extends Controller {
	...
	public function index() {
		if ($this->salesman->isLogged() && isset($this->request->get['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
		...
		$user_info = $this->model_salesman_user->getSalesmanByEmail($code);
		...
		if ($user_info) {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
				$this->model_salesman_user->editPassword($user_info['salesman_id'], $this->request->post['password']);
