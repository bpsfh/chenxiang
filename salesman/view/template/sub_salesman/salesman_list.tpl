...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <a href="<?php echo $edit_salesman; ?>"><?php echo $warning_commission_set; ?> </a>
      <button type="button" class="close" data-dismiss="alert">&times;</button>
    </div>
    <?php } ?>
    <?php if ($success) { ?>
        ...
        <div class="well">
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  <td class="text-left"><?php if ($sort == 'salesman_id') { ?>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-left"><?php echo $salesman['salesman_id']; ?></td>
