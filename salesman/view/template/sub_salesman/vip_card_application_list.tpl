  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-list"></i> <?php echo $text_list; ?>
        	<font class="cRed fS15"><?php echo '[' . $text_enabled_qty; ?><b><?php echo $enabled_qty; ?></b><?php echo ' ]'; ?></font>
        </h3>
      </div>
                ...
                <tr>
                  ...
                  <td class="text-right">
                  	<?php if ($application['apply_status'] == 0) { ?>
                  		<?php if ($enabled_qty > $application['apply_qty']) {?>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=sub_salesman/vip_card&token=<?php echo $token; ?>';
...
$('input[name=\'filter_fullname\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=sub_salesman/vip_card/autocomplete&token=<?php echo $token; ?>&filter_fullname=' +  encodeURIComponent(request),
			dataType: 'json',			
