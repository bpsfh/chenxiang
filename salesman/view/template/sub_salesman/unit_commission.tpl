            ...
            <thead>
              <tr>
                ...
                <td class="text-right"><?php if ($sort == 'commission') { ?>
                  ...
                  <?php } ?></td>
                 <td class="text-right"><?php echo $column_sub_commission; ?></td>
              </tr>
            </thead>
            <tbody>
              <?php if ($products) { ?>
              ...
              <tr>
                ...
                <td class="text-right"><?php if (isset($commissions[$product['product_id']]['sub_commission'])) { ?>
                  ...
                  <?php } ?>
                  <?php if (!empty($error_commission) && isset($error_commission[$product['product_id']])) { ?>
                      <div class="text-danger"><?php echo $error_commission[$product['product_id']]; ?></div>
                  <?php } ?>
                 </td>
              </tr>
              <?php } ?>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=sub_salesman/unit_commission&token=<?php echo $token; ?>';
...
//--></script> 
  ...
  $('input[name=\'filter_name\']').autocomplete({
		'source': function(request, response) {
			$.ajax({
				url: 'index.php?route=sub_salesman/unit_commission/autocomplete&token=<?php echo $token; ?>&filter_name=' + encodeURIComponent(request),
				dataType: 'json',			
