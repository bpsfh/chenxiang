...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <!--<div class="col-lg-6 col-md-12 col-sx-12 col-sm-12"><?php echo $chart_sale; ?></div>-->
      <!--<div class="col-lg-6 col-md-12 col-sx-12 col-sm-12"><?php echo $chart_bind; ?></div>-->
      <!--<div class="col-lg-6 col-md-12 col-sx-12 col-sm-12"><?php echo $chart_commission; ?></div>-->
    </div>
    <div class="row">
