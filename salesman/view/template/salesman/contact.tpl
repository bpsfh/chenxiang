...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo $text_contact; ?></h3>
      </div>
      <form action="<?php echo $add; ?>" method="post" enctype="multipart/form-data" id="form-contact-add" class="form-horizontal">
      <div class="panel-body">
          <div class="form-group required">
          <label class="col-sm-4 control-label" for="input-contact-title"><?php echo $text_title; ?></label>
          <div class="col-sm-3">
            <input type="text" name="contact_title" value="<?php echo $contact_title; ?>" id="input-contact-title" class="form-control" />
            <?php if ($error_contact_title) { ?>
            <div class="text-danger"><?php echo $error_contact_title; ?></div>
            <?php } ?>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-3">
            <input type="text" name="contact_phone" value="<?php echo $contact_phone; ?>" id="input-contact-phone" class="form-control" />
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3">
            <input type="text" name="contact_email" value="<?php echo $contact_email; ?>" id="input-contact-email" class="form-control" />
        ...
        <div class="form-group required">
          ...
          <div class="col-sm-6">
            <textarea  name="contact_content" rows="5" placeholder="<?php echo $text_contact_content; ?>" id="input-contact-content" class="form-control" ><?php echo $contact_content; ?></textarea>
            <?php if ($error_contact_content) { ?>
            <div class="text-danger"><?php echo $error_contact_content; ?></div>
            <?php } ?>
          </div>
        </div>
        <div class="form-group required">
        ...
        <div class="form-group pull-right col-sm-5">
             <button type="submit" form="form-contact-add" data-toggle="tooltip" title="<?php echo $button_submit; ?>" class="btn btn-primary"><i class="fa fa-send"></i> <?php echo $button_submit; ?></button>
        </div>
      </div>
	  </form>
    </div>
  ...
  $('#button-filter').on('click', function() {
  	url = 'index.php?route=salesman/contact&token=<?php echo $token; ?>';
