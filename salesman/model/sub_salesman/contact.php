<?php
class ModelSubSalesmanContact extends Model {
	...
	public function getContacts($data) {
		$sql = "SELECT * FROM " . DB_PREFIX . "salesman_contact WHERE contact_to = '".(int)$this->salesman->getId(). "'";
	...
	public function getTotalContacts($data){
		...
		$sql = "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "salesman_contact  WHERE contact_to = '".(int)$this->salesman->getId(). "'";
